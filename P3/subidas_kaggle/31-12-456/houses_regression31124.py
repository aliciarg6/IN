...
y_pred = (y_pred_xgb*0.3 + y_pred_lasso*0.4 + y_pred_elastic*0.3) # submission-31-12-4
...
y_pred_train = (xgbReg.predict(x_train)*0.3 + model_lasso.predict(x_train)*0.4 + model_elastic.predict(x_train)*0.3)
# y_pred_train = (xgbReg.predict(x_train)*0.3 + model_lasso.predict(x_train)*0.45 + model_elastic.predict(x_train)*0.25)
# y_pred_train = (xgbReg.predict(x_train) + model_elastic.predict(x_train) + model_lasso.predict(x_train))/3
get_score(y_pred_train,y_train)

outputName = 'submission_31-12-4.csv'
