...
model_lasso = LassoCV(alphas = [1, 0.1, 0.001, 0.0005]).fit(x_train_st, y_train)
...
#y_pred = (y_pred_xgb + y_pred_lasso)/2 # submission_30_12_2.
y_pred = 0.3*y_pred_xgb + 0.7*y_pred_lasso
#y_pred = (y_pred_xgb + y_pred_lasso*0.9)/1.9 # submission_30_12_3.
...
outputName = 'submission_30-12-4.csv'
